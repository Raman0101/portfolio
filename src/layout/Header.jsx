...
const Header = () => {
  return (
    <header className="sticky top-0 z-40 flex-none mx-auto w-full  bg-gray-900/90 backdrop-blur-sm border-b dark:border-b-0">
      <div className="py-3 px-3 mx-auto w-full flex justify-between align-middle max-w-6xl md:px-4">
        <a
          href="/"
          className="flex text-2xl font-bold text-white whitespace-nowrap dark:text-white"
          aria-label="Raman Kumar"
        >
          Raman Kumar
        </a>
        <div className="flex">
          ...
          <a 
          href="https://docs.google.com/forms/d/e/1FAIpQLSd-c8A2Md9IjHLTr7ec9vq3wmx1UhTbL9jIaL33Rxk-wkfrIA/viewform?usp=header"
          target='_blank'
